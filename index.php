                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" id="project-code" placeholder="IMT-XXX-XXXX" name="project-code" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                </div>
                            </div>
                            <div class="space-y-2">
